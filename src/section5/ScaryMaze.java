...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	int end = -13369595; 
		if (mouseColor == end) {
			JOptionPane.showMessageDialog(null, "Congrats! You escaped Freddy! For now...");
			showScaryImage("Download-1.jpg");
		}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("440066__drfx__music-box-melody-part-2.wav"));
